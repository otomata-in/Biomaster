                ...
                <ul>
                    ...
                    <li data-index="rs-100" data-transition="parallaxvertical" data-slotamount="default" data-hideafterloop="0" data-hideslideonmobile="off" data-easein="default" data-easeout="default" data-masterspeed="default" data-thumb="error-404.html" data-rotate="0" data-fstransition="fade" data-fsmasterspeed="1500" data-fsslotamount="7" data-saveperformance="off" data-title="A STUDY ON HAPPINESS" data-param1="" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="Science says that Women are generally happier">
                        ...
                        <div class="tp-caption Newspaper-Subtitle   tp-resizeme" id="slide-100-layer-3" data-x="['center','center','center','center']" data-hoffset="['0','0','0','0']" data-y="['top','top','top','top']" data-voffset="['210','210','210','210']" data-width="none" data-height="none" data-whitespace="nowrap" data-type="text" data-responsive_offset="on" data-frames='[{"from":"y:[-100%];z:0;rX:0deg;rY:0;rZ:0;sX:1;sY:1;skX:0;skY:0;","mask":"x:0px;y:0px;s:inherit;e:inherit;","speed":1500,"to":"o:1;","delay":1000,"ease":"Power3.easeInOut"},{"delay":"wait","speed":1000,"to":"auto:auto;","mask":"x:0;y:0;s:inherit;e:inherit;","ease":"Power3.easeInOut"}]' data-textAlign="['left','left','left','left']" data-paddingtop="[0,0,0,0]" data-paddingright="[0,0,0,0]" data-paddingbottom="[0,0,0,0]" data-paddingleft="[0,0,0,0]" style="z-index: 7; white-space: nowrap; color:#fff; font-family:rubik; font-size:18px; font-weight:400;">
                            Upgrade Your Medical Exam Preparation To The Next Level
                        </div>
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-6">
                        <div class="service-bx">
                            ...
                            <div class="info-bx text-center">
                                ...
                                <h4><a href="/expert">Expert Faculty</a></h4>
                                <a href="/expert" class="btn radius-xl">View More</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-4 col-sm-6">
                        <div class="service-bx">
                            ...
                            <div class="info-bx text-center">
                                ...
                                <h4><a href="/easeoflearning">Ease of Learning</a></h4>
                                <a href="easeoflearning" class="btn radius-xl">View More</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-4 col-sm-12">
                        <div class="service-bx m-b0">
                            ...
                            <div class="info-bx text-center">
                                ...
                                <h4><a href="/facilitiesforgrowth">Facilities for Growth</a></h4>
                                <a href="/facilitiesforgrowth" class="btn radius-xl">View More</a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-12 text-center heading-bx">
                        <h2 class="title-head m-b0">Current<span> Promotions</span></h2>
                        <p class="m-b0">Stay up to date with our recurring promotions and offers to avail the best
                            coaching under the most reasonable rates </p>
                    </div>
                </div>
                <div class="row">
                    <div class="upcoming-event-carousel owl-carousel owl-btn-center-lr owl-btn-1 col-12 p-lr0  m-b30">
                        ...
                        <div class="item">
                            <div class="event-bx">
                                <div class="action-box">
                                    <img src="/storage/{{ $p->p_image }}" alt="">
                                </div>
                                <!--<a href="{{ $p->p_target_url }}">-->
                                <!--<div class="info-bx d-flex">-->
                                <!--    <div>-->
                                        
                                <!--        <div class="event-time">-->
                                            <!--<div class="event-date">{{ $p->p_title }}</div>-->
                                <!--            <div class="event-month">{{ $p->p_title }}</div>-->
                                            <!--<h4 class="event-title"></h4>-->
                                <!--        </div>-->
                                <!--    </div>-->
                                <!--    <div class="event-info">-->
                                <!--        <h4 class="event-title">{{ $p->p_desc }}</h4>-->
                                ...
                                <!--</div>-->
                                 <div class="info-bx d-flex">
                                    ...
                                    <div class="event-info">
                                        <h4 class="event-title"><a href="{{ $p->p_target_url }}">{{ $p->p_title }}</a></h4>
            ...
            <div class="row">
                <div class="col-md-4 col-sm-6">
                    <div class="cours-search-bx m-b30">
                        <div class="icon-box">
                            <h3><i class="ti-user"></i><span class="counter">200</span>+</h3>
                        </div>
                        <span class="cours-search-text">Over 200 rank holders</span>
                    </div>
                </div>
                <div class="col-md-4 col-sm-6">
                    <div class="cours-search-bx m-b30">
                        <div class="icon-box">
                            <h3><i class="ti-book"></i><span class="counter">3</span>+</h3>
                        </div>
                        <span class="cours-search-text">3+ Courses.</span>
                    </div>
                </div>
                <div class="col-md-4 col-sm-12">
                    <div class="cours-search-bx m-b30">
                        ...
                        <span class="cours-search-text">Quality Teaching</span>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12 heading-bx left">
                ...
                <p>We are offering a plethora of course options to suit from that will be best suited for your
                    child</p>
            </div>
        </div>
        <div class="row">
                                ...
                                <div class="info-bx d-flex">
                                    <div>
                                        <div class="event-time">
                                            ...
                                            <div class="event-month">Hour/Day</div>
                                        </div>
                                    </div>
                                    <div class="event-info">
                                        <h4 class="event-title">NEET Repeater Course</h4>
                                        <p style="font-weight: bold;">2/3 of NEET qualifiers are repeaters</p>
                                        <span>2 Days Revision</span>
                                        <br>
                                        <span>3 Days Mocks</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="item">
                            <div class="event-bx">
                                ...
                                <div class="info-bx d-flex">
                                    ...
                                    <div class="event-info">
                                        <h4 class="event-title">+1 Program & +2 Program </h4>
                                        <p style="font-weight: bold;">Residential School Programme</p>
                                        <span>Contact us for hostel accommodation guidance</span>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12 text-white heading-bx left">
                ...
                <p>Valuable feedback from our valuable students.</p>
            </div>
        </div>
            ...
            <div class="item">
                <div class="testimonial-bx">
                    <div class="testimonial-thumb">
                            @if($t->t_image == "noimage")
                                <img src="{{ asset('assets/images/testimonials/profile.png') }}" alt="">
                            @else
                                <img src="/storage/{{ $t->t_image }}" alt="">
                            @endif
                    </div>
                    <div class="testimonial-info">
                        <h5 class="name">{{$t->t_name}}</h5>
                        <p>{{$t->t_student_parent}}</p>
                    </div>
