...
<head>
	...
	<meta name="author" content="oto_m_ata" />
	<meta name="robots" content="" />

	<!-- DESCRIPTION -->
	<meta name="description" content="Biomaster" />

	<!-- OG -->
	<meta property="og:title" content="Biomaster" />
	<meta property="og:description" content="Biomaster" />
	...
	<div class="page-wraper">
					...
					<div class="container clearfix">
						...
						<div class="secondary-menu">
							<div class="secondary-inner">
								<ul>
									<li><a href="https://www.facebook.com/profile.php?id=100091786393587" class="btn-link"><i class="fa fa-facebook"></i></a></li>
									<li><a href="https://twitter.com/BioMast30691366" class="btn-link"><i class="fa fa-twitter"></i></a></li>
									<li><a href="https://www.linkedin.com/company/bio-mater-india/" class="btn-link"><i class="fa fa-linkedin"></i></a></li>
									<li><a href="https://www.instagram.com/biomaster_india/?igshid=MzNlNGNkZWQ4Mg%3D%3D" class="btn-link"><i class="fa fa-instagram"></i></a></li>
								</ul>
							</div>
						</div>
						<!-- Search Box ==== -->
						...
						<div class="menu-links navbar-collapse collapse justify-content-start" id="menuDropdown">
							...
							<ul class="nav navbar-nav">
								...
								<!-- <li><a href="/enquiry">WhatsApp </i></a> -->
							</ul>
		...
		<footer>
					...
					<div class="container">
						<div class="d-flex align-items-stretch">
							...
							<div class="pt-btn-join">
								<a href="/message" class="btn ">Join Now</a>
							</div>
						</div>
					</div>
				</div>
					...
					<div class="row">
						<div class="col-lg-6 col-md-12 col-sm-12 footer-col-4">
							<div class="widget">
								...
								<p class="text-capitalize m-b20">BIOMASTER 
										PROF N  D GEORGE MEMORIAL CENTRE,
										KIZHAKUMPATTUKARA,
										EASTFORT,
										THRISSUR
										</p>
								<div class="subscribe-form m-b20">
									<strong>Office Time:</strong> 9AM- 5PM
								</div>
							</div>
						</div>
							...
							<div class="widget">
								<h5 class="footer-title">Contact us</h5>
										<ul>
											<li><a href="tel:+91 8943544441">+91 8943544441</a></li>
											<li><a href="tel:+91 8943544442">+91 8943544442</a></li>
											<li><a href="tel:+91 8943544443">+91 8943544443</a></li>
							...
							<div class="col-lg-3 col-md-12 col-sm-12 footer-col-4">
							<div class="widget">
								<h5 class="footer-title">Mail</h5>
										<ul>
											<li><a href="mailto:biomastertcr@gmail.com">biomastertcr@gmail.com</a></li>
										</ul>
							</div>
						</div>
						...
						<!-- <div class="col-12 col-lg-3 col-md-5 col-sm-12 footer-col-4">
							<div class="widget widget_gallery gallery-grid-4">
								...
								<ul class="magnific-image">
									...
									<li><a href="assets/images/gallery/pic9.jpg" class="magnific-anchor"><img src="{{ asset('assets/images/gallery/pic9.jpg') }}" alt=""></a></li>
									<li><a href="assets/images/gallery/pic10.jpg" class="magnific-anchor"><img src="{{ asset('assets/images/gallery/pic10.jpg') }}" alt=""></a></li>
									<li><a href="assets/images/gallery/pic11.jpg" class="magnific-anchor"><img src="{{ asset('assets/images/gallery/pic11.jpg') }}" alt=""></a></li>
								</ul>
							</div>
						</div> -->
					</div>
			...
			<div class="footer-bottom">
				<div class="container">
					<div class="row">
						<div class="col-lg-12 col-md-12 col-sm-12 text-center"> <a target="_blank" href="https://www.otomata.in">oto_m_ata.in</a></div>
					</div>
				</div>
			</div>
		</footer>
