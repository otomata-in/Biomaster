            ...
            <nav class="ttr-sidebar-navi">
                <ul>
                    ...
                    <li>
                        ...
                        <ul>
                            <li>
                                <a href="/admin/registration/details" class="ttr-material-button"><span class="ttr-label">Inbox</span></a>
                            </li>
                    ...
                    <li>
                        <a href="/admin/posters" class="ttr-material-button">
                            <span class="ttr-icon"><i class="ti-layout-grid3-alt"></i></span>
                            <span class="ttr-label">Posters</span>
                        </a>
                    </li>

                    <li>
                        <a href="/admin/testimonials" class="ttr-material-button">
